#ifndef SQUAREDGRID_HPP
#define SQUAREDGRID_HPP
...
struct SquaredGrid {
    ...
    SquaredGrid(int width_, int height_) : width(width_), height(height_) {}
...
void draw_grid(const SquaredGrid& grid, int field_width,
...
SquaredGrid make_diagram1() {
  SquaredGrid grid(30, 15);
